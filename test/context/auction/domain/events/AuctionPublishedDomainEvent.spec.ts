import { AuctionPublishedDomainEvent } from 'src/context/auction/domain/events/AuctionPublishedDomainEvent';

describe('AuctionPublishedDomainEvent', () => {
    it('should create event with all properties', () => {
        const event = new AuctionPublishedDomainEvent({
        ...
        expect(event.eventName).toBe('auction.published');
    ...
    it('should convert to primitives correctly', () => {
        ...
        expect(primitives.eventName).toBe('auction.published');
    ...
    it('should reconstruct from primitives', () => {
        ...
        const event = AuctionPublishedDomainEvent.fromPrimitives(params);
    ...
    it('should have correct EVENT_NAME', () => {
        expect(AuctionPublishedDomainEvent.EVENT_NAME).toBe('auction.published');
    });
});
